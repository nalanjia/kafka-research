...
public class MetadataResponseData implements ApiMessage {
    ...
    public void write(Writable writable, short version) {
        ...
        if (version >= 8) {
            writable.writeInt(clusterAuthorizedOperations);
        }
    }
    ...
    public void fromStruct(Struct struct, short version) {
        ...
        }
        {
            ...
            this.brokers = new MetadataResponseBrokerCollection(nestedObjects.length);
        ...
        }
        {
            ...
            this.topics = new MetadataResponseTopicCollection(nestedObjects.length);
            for (Object nestedObject : nestedObjects) {
    ...
    static public class MetadataResponseTopic implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public void write(Writable writable, short version) {
            ...
            if (version >= 8) {
                writable.writeInt(topicAuthorizedOperations);
            }
        }
