...
public enum ApiMessageType {
    ...
    ELECT_PREFERRED_LEADERS("ElectPreferredLeaders", (short) 43, ElectPreferredLeadersRequestData.SCHEMAS, ElectPreferredLeadersResponseData.SCHEMAS),
    ...
    public static ApiMessageType fromApiKey(short apiKey) {
        switch (apiKey) {
            ...
            case 43:
                return ELECT_PREFERRED_LEADERS;
            case 44:
